...
/* Define if compiling with the ipfwchains/ipfwchains module files.  */
#define USING_IPFWCHAINS_IPFWCHAINS_MODULE 1
...
/* Define if compiling with the ipfwchains/libipfwc module files.  */
#define USING_IPFWCHAINS_LIBIPFWC_MODULE 1
